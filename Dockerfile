...
FROM ghcr.io/blinklabs-io/cardano-cli:10.5.0.0-1 AS cardano-cli
FROM ghcr.io/blinklabs-io/cardano-configs:20250213-1 AS cardano-configs
FROM ghcr.io/blinklabs-io/mithril-client:0.11.0-1 AS mithril-client
FROM ghcr.io/blinklabs-io/mithril-signer:0.2.228-1 AS mithril-signer
